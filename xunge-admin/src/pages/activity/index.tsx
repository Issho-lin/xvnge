 ...
 * @LastEditTime: 2025-06-19 17:03:43
 * @Description:
 *
...
const DiscountsActivity: React.FC = () => {
  const {
    records,
    loading,
    total,
    ...
    name: "活动",
    fetch: getActivityPagesApi,
    delete: delActivityApi,
    unpublish: unpublishActivityApi,
  });
  ...
  return (
    <>
      ...
      <Row justify="space-between" style={{ marginBottom: 10 }}>
        <AddButton url="/activity/create" label="新增活动" />
...
export default DiscountsActivity;
