 ...
 * @LastEditTime: 2025-06-17 15:23:26
 * @Description: 
 * 
 * Copyright (c) 2025 by 智慧空间研究院/金地空间科技, All Rights Reserved. 
 */
import { delDocApi, getDocPagesApi, unpublishDocApi } from "@/api/document";
...
const TechnologyDocument: React.FC = () => {
  const {
    records,
    loading,
    total,
    ...
    name: '文档',
    fetch: getDocPagesApi,
    delete: delDocApi,
    unpublish: unpublishDocApi
  })
  ...
  return (
    <>
      ...
      <Row justify="space-between" style={{ marginBottom: 10 }}>
        <AddButton url="/document/create" label="新增文档" />
        <Row style={{ margin: '5px 0' }}>
          <Form layout="inline" form={queryForm}>
            <Form.Item name="docName">
              <Input placeholder="文档名称" style={{ width: 200 }} />
            </Form.Item>
...
export default TechnologyDocument;
